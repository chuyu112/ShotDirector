...
const WORKER_ENV_KEYS = new Set([
  ...
  "JIEKOU_ANTHROPIC_BASE_URL", "MANJING_JIEKOU_ANTHROPIC_BASE_URL",
  "KONJAC_API_KEY", "KONJAC_API_URL", "KONJAC_LUNA_MODEL",
  "MANJING_KONJAC_API_KEY", "MANJING_KONJAC_BASE_URL", "MANJING_KONJAC_LUNA_MODEL",
