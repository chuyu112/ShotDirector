...
const WORKER_ENV_KEYS = new Set([
  ...
  "MANJING_CODEX_ENABLED", "MANJING_CODEX_BIN", "MANJING_CODEX_HOME", "MANJING_CODEX_MODEL",
  "MANJING_CODEX_ALLOWED_TENANT_IDS", "MANJING_MANGA_CROP_MODEL",
...
const WORKER_ENV_PREFIXES = [
  "MANJING_OPENAI_IMAGE_", "MANJING_REVIEWER_SECRET_",
];
